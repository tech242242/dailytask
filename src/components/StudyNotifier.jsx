...
export default function StudyNotifier() {
  ...
  return (
    <div className="p-5 rounded-2xl border border-white/20 backdrop-blur-lg bg-white/10 shadow-lg glass-hover text-white relative overflow-hidden">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-lg text-sm transition-all ${
            active ? "bg-red-500 hover:bg-red-600" : "bg-blue-500 hover:bg-blue-600"
          }`}
        >
      ...
      <div className="flex items-center gap-2 text-sm mt-3 opacity-80">
